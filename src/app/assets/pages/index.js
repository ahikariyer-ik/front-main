...
import Hakkimizda from "../componants/hakkimizda";
...
import { FiClock, FiMapPin, FiSearch } from "../assets/icons/vander";
...
export default function Index(){
    ...
    return(
        ...
        <section className="section">
            <Hakkimizda containerClass="container"/>
            <Categories/>
            ...
            <div className="container mt-100 mt-60">
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6 col-md-6 mt-4 pt-2 mt-sm-0 pt-sm-0 order-md-1 order-2">
                        ...
                        <div className="mt-4">
                            <Link to="/is-verenler" className="btn btn-link primary text-muted">Tüm Şirketler <i className="mdi mdi-arrow-right align-middle"></i></Link>
                        </div>
                    </div>
                </div>
            </div>
