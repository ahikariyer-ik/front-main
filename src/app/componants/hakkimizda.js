...
export default function Hakkimizda({containerClass}){
                ...
                <div className="row g-4 align-items-center">
                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="section-title ms-lg-5">
                            ...
                            <div className="mt-4">
                                <Link href="/hakkimizda" className="btn btn-primary">Hakkımızda <i className="mdi mdi-arrow-right align-middle"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
